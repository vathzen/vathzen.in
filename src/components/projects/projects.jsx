                        ...
                        <div className="project">
                            ...
                            <div className="proj-info">
                                ...
                                <div className="project-links">
                                    Project Website :&nbsp;<a href="https://2019.igem.org/Team:SASTRA_Thanjavur"> SASTRA Thanjavur iGEM 2019</a>&nbsp;
                                    Toehold Design :&nbsp;<a href="https://sas.sastra.edu/rnatoedesign/"> Toehold Designer</a>&nbsp;
                                    Instagram :&nbsp;<a href="https://www.instagram.com/igem_sastra/"> iGEM @ Sastra </a>
                                </div>
                            </div>                           
                        </div>
                        <hr />
                        <div className="project">
                            ...
                            <div className="proj-info">
                                ...
                                <div className="project-links-col">
                                    Project Website :&nbsp;<a href="https://yumsastra.vathzen.in/"> Yum - Sastra</a>&nbsp; <br />
                                    Github :
                                    <ul>
                                        <li>Backend : <a href="https://github.com/vathzen/mess-backend">mess-backend</a></li>
                                        <li>Student App : <a href="https://github.com/vathzen/SASTRAMess">mess-backend</a></li>
                                        <li>Admin Front End : <a href="https://github.com/vathzen/WebAppMess">mess-backend</a></li>
                                    </ul>
                                </div>
                            </div>                           
                        </div>
